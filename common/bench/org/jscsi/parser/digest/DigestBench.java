...
public class DigestBench {
	...
	/**
	 * Measures the time to calculate the CRC32 digest value of a byte array
	 * with random-filled content.
	 */
	...
	/**
	 * Measures the time to calculate the CRC32C digest value of a byte array
	 * with random-filled content.
	 */
