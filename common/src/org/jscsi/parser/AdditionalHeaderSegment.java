...
final class AdditionalHeaderSegment {
  ...
  enum AdditionalHeaderSegmentType {
    /**
     * This type of AHS MUST NOT be used if the <code>CDBLength</code> is less
     * than <code>17</code>. The length includes the reserved byte
     * <code>3</code>.
     */
    EXTENDED_CDB((byte) 1),
  ...
  /**
   * Clears all the stored content of this <code>AdditionalHeaderSegment</code>
   * object.
   */
  final void clear() {
