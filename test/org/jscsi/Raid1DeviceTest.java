 ...
 * 
 * $Id: Raid1DeviceTest.java 2641 2007-04-10 09:46:28Z lemke $
 * 
 */
...
public class Raid1DeviceTest {
  ...
  /**
   * Tests, if an exception is thrown, when data is written to an unopened Raid1
   * Device.
   * 
   * @throws Exception
   *           These should never be thrown.
  ...
  /**
   * Tests, if an exception is thrown, when data is read from an unopened Raid1
   * Device.
   * 
   * @throws Exception
   *           These should never be thrown.
