...
/**
 * <h1>SimpleLoadBalancer</h1> <p/> This simple load balancer distribute only
 * the work to the first connection.
 * 
 * @author Volker Wildi
 */
public final class SimpleTaskBalancer extends AbstractTaskBalancer {
   ...
   */
  public SimpleTaskBalancer(final LinkedBlockingQueue<Connection> initConnections) {
  ...
  public Connection getConnection() throws NoSuchConnectionException {
    ...
    try {
      ...
      usedConnections.add(retConnection);
