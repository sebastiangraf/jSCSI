...
public class Write10 extends AbstractCommandDescriptorBlock
{
   ...
   private long transferLength; // USHORT_MAX
   
   static
   {
      CommandDescriptorBlockFactory.register(OPERATION_CODE, Write10.class);
   }
   ...
   public Write10(long logicalBlockAddress, long transferLength, int groupNumber, boolean dpo,
