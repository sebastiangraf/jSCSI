...
public class Read10 extends AbstractCommandDescriptorBlock
{
   ...
   static
   {
      CommandDescriptorBlockFactory.register(OPERATION_CODE, Read10.class);
   }
   ...
   public Read10(long logicalBlockAddress, long transferLength, int groupNumber, boolean dpo,
