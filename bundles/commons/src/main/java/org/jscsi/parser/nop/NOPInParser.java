 ...
 * NOPInParser.java 2500 2007-03-05 13:29:08Z lemke $
 */
 ...
 * reserved value <code>0xffffffff</code>), it MUST respond with a NOP-In with
 * the same Initiator Task Tag that was provided in the NOP-Out request. It MUST
 * also duplicate up to the first <code>MaxRecvDataSegmentLength</code> bytes of
 * the initiator provided Ping Data. For such a response, the Target Transfer
 * Tag MUST be <code>0xffffffff</code>.
 * <p>
