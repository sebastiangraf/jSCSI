 ...
 * LogoutResponseParser.java 2500 2007-03-05 13:29:08Z lemke $
 */
...
public final class LogoutResponseParser extends TargetMessageParser {
   ...
   * <p>
   * If the Logout response code is <code>2</code> or <code>3</code>, this field
   * specifies the maximum amount of time, in seconds, after the initial wait
   ...
   * <p>
   * If the Logout response code is <code>2</code> or <code>3</code>, this field
   * specifies the minimum time to wait before attempting a new implicit or
   * explicit logout.
   * <p>
