 ...
 * BasicHeaderSegment.java 2498 2007-03-05 12:32:43Z lemke $
 */
...
public final class BasicHeaderSegment {
   ...
   * opcodes and <em>target</em> opcodes. Initiator opcodes are in PDUs sent by
   * the initiator (request PDUs). Target opcodes are in PDUs sent by the target
   * (response PDUs).
   * <p>
  ...
  /**
   * Total length of all AHS header segments in units of <code>four</code> byte
