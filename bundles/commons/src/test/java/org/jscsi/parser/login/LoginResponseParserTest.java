 ...
 * LoginResponseParserTest.java 2500 2007-03-05 13:29:08Z lemke $
 */
...
public class LoginResponseParserTest extends ProtocolDataUnitTest {
   ...
   * Flag = <code>false</code><br/> Operation Code = <code>LOGIN_RESPONSE</code>
   ...
   * minVersion = <code>0x0002</code><br/> maxVersion = <code>0x0002</code>
   * <br/><br/> TotalAHSLength = <code>0x00000000</code><br/> DataSegmentLength
   * = <code>0x00000010</code><br/> <b>ISID:</b><br/> <blockquote> t =
   ...
   * TSIH = <code>0x0000</code><br/> CID = <code>0x0000</code><br/> StatSN =
   * <code>0x00000000</code><br/> ExpCmdSN = <code>0x00000001</code><br/>
   * MaxCmdSN = <code>0x00000008</code><br/> Status = <code>SUCCESS</code>
   * </br><br/> <b>Key-Values:</b><br/> AUTH_METHOD = <code>none</code><br/>
   * </blockquote>
   */
   ...
   * <br/><br/> TotalAHSLength = <code>0x00000000</code><br/> DataSegmentLength
   * = <code>0x0000012C</code><br/> <b>ISID:</b><br/> <blockquote> t =
   * <code>ISID.OUI_FORMAT</code><br/> a = <code>0x00</code><br/> b =
   ...
   * MaxCmdSN = <code>0x00000001</code><br/> Status = <code>SUCCESS</code>
   * </br><br/> <b>Key-Values:</b><br/> TARGET_PORTAL_GROUP_TAG = <code>1</code>
   * <br/> HEADER_DIGEST = <code>None</code><br/> DATA_DIGEST =
   * <code>None</code><br/> DEFAULT_TIME_2_WAIT = <code>2</code><br/>
   * DEFAULT_TIME_2_RETAIN = <code>0</code><br/> IF_MARKER = <code>No</code>
   * <br/> OF_MARKER = <code>No</code><br/> ERROR_RECOVERY_LEVEL =
   * <code>0</code><br/> INITIAL_R2T = <code>Yes</code><br/> IMMEDIATE_DATA =
   * <code>Yes</code><br/> MAX_BURST_LENGTH = <code>262144</code><br/>
   * FIRST_BURST_LENGTH = <code>65536</code><br/> MAX_OUTSTANDING_R2T =
   * <code>1</code><br/> MAX_CONNECTIONS = <code>1</code><br/> DATA_PDU_IN_ORDER
   * = <code>Yes</code><br/> DATA_SEQUENCE_IN_ORDER = <code>Yes</code><br/>
   * </blockquote>
   */
  private static final String TEST_CASE_2 = "23 87 00 00 00 00 01 2c 00 02 3d 00 00 00 01 00 "
      ...
      + "59 65 73 00 44 61 74 61 53 65 71 75 65 6e 63 65 "
      + "49 6e 4f 72 64 65 72 3d 59 65 73 00";
  ...
  public void testDeserialize() throws IOException, InternetSCSIException,
    ...
    super.testDeserialize(false, false, OperationCode.LOGIN_RESPONSE,
        0x00000000, 0x00000010, 0xC8D04B81);
  ...
  public void testDeserialize2() throws IOException, InternetSCSIException,
    ...
    // final flag is here the transit flag
    super.testDeserialize(false, true, OperationCode.LOGIN_RESPONSE,
        0x00000000, 0x0000012C, 0x000A0000);
    super.testDataSegment(expectedKeyValuePair);
    ...
    ISID expectedISID = new ISID(Format.OUI_FORMAT, (byte) 0x00,
        (short) 0x023D, (byte) 0x00, (short) 0x0000);
    assertTrue(expectedISID.equals(parser.getInitiatorSessionID()));
