 ...
 * LoginRequestParserTest.java 2500 2007-03-05 13:29:08Z lemke $
 */
...
public class LoginRequestParserTest extends ProtocolDataUnitTest {
   ...
   * Flag = <code>true</code><br/> Operation Code = <code>LOGIN_REQUEST</code>
   * <br/> Final Flag (Transit Flag) = <code>false</code><br/> Continue Flag =
   * <code>false</code><br/> CSG = <code>LoginStage.SECURITY_NEGOTIATION</code>
   * <br/> NSG = <code>LoginStage.SECURITY_NEGOTIATION</code><br>
   * minVersion = <code>0x0000</code><br/> maxVersion = <code>0x0000</code>
   * <br/><br/> TotalAHSLength = <code>0x00000000</code><br/> DataSegmentLength
   * = <code>0x00000095</code><br/> <b>ISID:</b><br/> <blockquote> t =
   * <code>ISID.OUI_FORMAT</code><br/> a = <code>0x00</code><br/> b =
   * <code>0x0000</code><br/> c = <code>0x00</code><br/> d = <code>0xABCD</code>
   * <br/><br/> </blockquote> InitiatorTaskTag = <code>0xC8D04B81</code><br/>
   * TSIH = <code>0x0000</code><br/> CID = <code>0x0000</code><br/> CmdSN =
   * <code>0x00000001</code><br/> ExpStatSN = <code>0x00000000</code><br/><br/>
   * <b>Key-Values:</b><br/> INITIATOR_NAME = <code>iqn.com.ibm.k-machine</code>
   * <br/> TARGET_NAME =
   * <code>iqn.1987-05.com.cisco.00.58031e1d068ac226d385847592c0b670.IBM-Disk</code>
   * <br/> AUTH_METHOD = <code>none</code><br/> SESSION_TYPE =
   * <code>normal</code><br/> </blockquote>
   */
  private static final String TEST_CASE_1 = "43 00 00 00 00 00 00 95 00 00 00 00 ab cd 00 00 "
      ...
      + "65 00 53 65 73 73 69 6f 6e 54 79 70 65 3d 6e 6f "
      + "72 6d 61 6c 00 00 00 00";

  /**
   * Valid Test Case with the following expected values. <blockquote> Immediate
   * Flag = <code>true</code><br/> Operation Code = <code>LOGIN_REQUEST</code>
   * <br/> Final Flag (Transit Flag) = <code>true</code><br/> Continue Flag =
   * <code>false</code><br/> CSG =
   * <code>LoginStage.LOGIN_OPERATIONAL_NEGOTIATION</code><br/> NSG =
   * <code>LoginStage.FULL_FEATURE_PHASE</code><br>
   * minVersion = <code>0x0000</code><br/> maxVersion = <code>0x0000</code>
   * <br/><br/> TotalAHSLength = <code>0x00000000</code><br/> DataSegmentLength
   * = <code>0x000001AE</code><br/> <b>ISID:</b><br/> <blockquote> t =
   * <code>ISID.OUI_FORMAT</code><br/> a = <code>0x00</code><br/> b =
   * <code>0x023D</code><br/> c = <code>0x00</code><br/> d = <code>0x0000</code>
   * <br/><br/> </blockquote> InitiatorTaskTag = <code>0x000A0000</code><br/>
   * TSIH = <code>0x0000</code><br/> CID = <code>0x0000</code><br/> CmdSN =
   * <code>0x00000000</code><br/> ExpStatSN = <code>0x00000000</code><br/><br/>
   * <b>Key-Values:</b><br/> INITIATOR_NAME =
   * <code>iqn.1987-05.com.cisco:01.ac24953f3f9</code><br/> INITIATOR_ALIAS,
   * "Initiator" TARGET_NAME = <code>disk1</code><br/> SESSION_TYPE =
   * <code>Normal</code><br/> HEADER_DIGEST = <code>None,CRC32CDigest</code>
   * <br/> DATA_DIGEST = <code>None</code><br/> DEFAULT_TIME_2_WAIT =
   * <code>0</code><br/> DEFAULT_TIME_2_RETAIN = <code>0</code><br/>
   * ERROR_RECOVERY_LEVEL = <code>0</code><br/> INITIAL_R2T = <code>No</code>
   * <br/> IMMEDIATE_DATA = <code>Yes</code><br/> MAX_BURST_LENGTH =
   * <code>16776192</code><br/> FIRST_BURST_LENGTH = <code>262144</code><br/>
   * MAX_OUTSTANDING_R2T = <code>1</code><br/> MAX_CONNECTIONS = <code>1</code>
   * <br/> DATA_PDU_IN_ORDER = <code>Yes</code><br/> DATA_SEQUENCE_IN_ORDER =
   * <code>Yes</code><br/> MAX_RECV_DATA_SEGMENT_LENGTH = <code>131072</code>
   * <br/> IF_MARKER = <code>No</code><br/> OF_MARKER = <code>No</code><br/>
   * </blockquote>
   */
  ...
  public void testDeserialize1() throws IOException, InternetSCSIException,
    ...
    expectedKeyValuePair.add(OperationalTextKey.INITIATOR_NAME,
        "iqn.com.ibm.k-machine");
    ...
    super.testDeserialize(true, false, OperationCode.LOGIN_REQUEST, 0x00000000,
        0x00000095, 0xC8D04B81);
    ...
    assertEquals(LoginStage.SECURITY_NEGOTIATION, parser
  ...
  public void testDeserialize2() throws IOException, InternetSCSIException,
    ...
    SettingsMap expectedKeyValuePair = new SettingsMap();
    expectedKeyValuePair.add(OperationalTextKey.INITIATOR_NAME,
        "iqn.1987-05.com.cisco:01.ac24953f3f9");
    ...
    expectedKeyValuePair.add(OperationalTextKey.SESSION_TYPE, "Normal");
    expectedKeyValuePair.add(OperationalTextKey.HEADER_DIGEST,
        "None,CRC32CDigest");
    ...
    expectedKeyValuePair.add(OperationalTextKey.MAX_RECV_DATA_SEGMENT_LENGTH,
        "131072");
    ...
    super.testDeserialize(true, true, OperationCode.LOGIN_REQUEST, 0x00000000,
        0x000001AE, 0x000A0000);
    super.testDataSegment(expectedKeyValuePair);
    ...
    // test login request fields
    assertFalse(parser.isContinueFlag());
    assertEquals(LoginStage.LOGIN_OPERATIONAL_NEGOTIATION, parser
        .getCurrentStageNumber());
    ...
    // test ISID fields
    ISID expectedISID = new ISID(Format.OUI_FORMAT, (byte) 0x00, (short) 0x23D,
        (byte) 0x00, (short) 0x0000);
    assertTrue(expectedISID.equals(parser.getInitiatorSessionID()));
