 ...
 * <code>READ CAPACITY (10)</code> or <code>READ CAPACITY (16)</code> SCSI command
 * and is mainly used to inform the initiator about the number and length of the
 * unit's logical blocks.
