...
/**
 * The OPERATION CODE of a Command Descriptor Block specifies the type of command
 * the initiator wants the target to perform.
 * <p>
 * The OPERATION CODE of the {@link CommandDescriptorBlock} has a GROUP CODE field and a
 * COMMAND CODE field. The three-bit GROUP CODE field provides for eight groups of command
 * codes. The five-bit COMMAND CODE field provides for thirty-two command codes in each
 * group. A total of 256 possible operation codes exist.
 * <p>
...
public enum ScsiOperationCode {
	...
	/**
	 * Maps byte values/index positions to {@link ScsiOperationCode}
	 * constants.
	 */
	private static final ScsiOperationCode[] mapping =
		new ScsiOperationCode[256];
	...
	/**
	 * Returns the {@link ScsiOperationCode} corresponding to the
	 * passed byte value.
	 * @param value the serialized value of a SCSI operation code
	 * @return the corresponding {@link ScsiOperationCode} or
	 * <code>null</code> if the passed value is not known by the
	 * jSCSI Target 
	 */
