...
public final class DescriptorFormatSenseData extends SenseData {
	...
	/**
	 * The length in bytes of all fixed fields of descriptor
	 * format sense data.
	 */
	...
	/**
	 * All sense data descriptors that are a part of this sense
	 * data object.
	 */
	 ...
	 * @param additionalSenseCodeAndQualifier a more specific description
	 * of the error
	 * @param senseDataDescriptors more specific error information
	 */
	public DescriptorFormatSenseData(
	...
	public void serialize(ByteBuffer byteBuffer, int index) {
		...
		for (int i = index + RESERVED_BYTES_MIN_INDEX;
			i < index + RESERVED_BYTES_MAX_INDEX; ++i)
