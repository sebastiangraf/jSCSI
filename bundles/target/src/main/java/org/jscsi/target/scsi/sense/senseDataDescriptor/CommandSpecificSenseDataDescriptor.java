 ...
 * information that depends on the command on which the exception
 * condition occurred.
...
public class CommandSpecificSenseDataDescriptor extends SenseDataDescriptor {
	...
	/**
	 * The constructor.
	 * @param commandSpecificInformation {@link EightByteInformation}
	 * which should contain command-specific information.
	 */
	public CommandSpecificSenseDataDescriptor(
			final EightByteInformation commandSpecificInformation) {
		super(SenseDataDescriptorType.COMMAND_SPECIFIC_INFORMATION,
	...
	protected void serializeSpecificFields(ByteBuffer byteBuffer, int index) {
		commandSpecificInformation.serialize(byteBuffer,
				index + COMMAND_SPECIFIC_INFORMATION_INDEX);
	}
