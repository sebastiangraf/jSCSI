...
public final class InformationSenseDataDescriptor extends SenseDataDescriptor {
	 ...
	 * <p>
	 * In previous versions of this standard and in the fixed format sense data, the
	 * VALID bit indicates whether the contents of the INFORMATION field is valid as
	 * defined by a command standard. Since the contents of the INFORMATION field are
	 * valid whenever an information sense data descriptor is included in the sense
	...
	/**
	 * The constructor.
	 * @param information {@link EightByteInformation} that may contain
	 * useful information
	 */
