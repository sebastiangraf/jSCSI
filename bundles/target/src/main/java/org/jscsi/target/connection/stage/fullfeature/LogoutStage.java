 ...
 * <p>
 * Since <code>MaxConnections</code> is currently limited to <code>1</code>,
 * all logout requests will be treated as requests to close the session.
...
public final class LogoutStage extends TargetFullFeatureStage {
	...
	public void execute(ProtocolDataUnit pdu) throws IOException,
		...
		final ProtocolDataUnit responsePDU = TargetPduFactory.createLogoutResponsePdu(
