...
/**
 * Actual retry count sense-key-specific data is used to communicate the number of
 * retries of the recovery algorithm used in attempting to recover an error or
 * exception condition.
...
public final class ActualRetryCountSenseKeySpecificData extends SenseKeySpecificData {
	...
	/**
	 * The ACTUAL RETRY COUNT field returns vendor specific information on the number
	 * of retries of the recovery algorithm used in attempting to recover an error or
	 * exception condition.
	 * <p>
	 * This field should be computed in the same way as the retry count fields within
	...
	/**
	 * The constructor.
	 * @param senseKeySpecificDataValid <code>true</code> if and only if the second
