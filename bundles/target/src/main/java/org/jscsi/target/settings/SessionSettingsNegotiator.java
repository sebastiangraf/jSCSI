...
public final class SessionSettingsNegotiator extends SettingsNegotiator {
     ...
     * <code>true</code> or returns <code>false</code> if the method returned
     * prematurely due to an interrupt.
     * <p>
     * The usual safeguards with using {@link Lock} objects should be applied,
     * namely using <code>try ...  catch ... finally ...</code> blocks to make
     * sure the lock is always released.
     * 
    ...
    protected void initializeEntries() {
         ...
         */
        entries.add(new BooleanEntry(new KeySet(
                TextKeyword.DATA_SEQUENCE_IN_ORDER),// keySet
                Use.LEADING_LOPNS,// use
                NegotiationStatus.DEFAULT,// negotiationStatus
                true,// negotiationValue
                BooleanResultFunction.OR,// resultFunction
        ...
        entries.add(new NumericalEntry(new KeySet(
                TextKeyword.DEFAULT_TIME_2_RETAIN, TextKeyword.TIME_2_RETAIN),// keySet
         ...
         */
        entries.add(new NumericalEntry(new KeySet(
                TextKeyword.DEFAULT_TIME_2_WAIT, TextKeyword.TIME_2_WAIT),// keySet
                NegotiationType.NEGOTIATED,// negotiationType
                Use.LEADING_LOPNS,// use
                NegotiationStatus.DEFAULT,// negotiationStatus
                2,// negotiationValue
         ...
         */
        entries.add(new NumericalEntry(new KeySet(
                TextKeyword.ERROR_RECOVERY_LEVEL),// keySet
                NegotiationType.NEGOTIATED,// negotiationType
                Use.LEADING_LOPNS,// use
                NegotiationStatus.DEFAULT,// negotiationStatus
                0,// negotiationValue
         ...
         */
        entries.add(new NumericalEntry(new KeySet(
                TextKeyword.FIRST_BURST_LENGTH),// keySet
                NegotiationType.NEGOTIATED,// negotiationType
                Use.LEADING_LOPNS,// use
                NegotiationStatus.DEFAULT,// negotiationStatus
         ...
         */
        entries.add(new NumericalEntry(new KeySet(
                TextKeyword.MAX_OUTSTANDING_R_2_T),// keySet
                NegotiationType.NEGOTIATED,// negotiationType
                Use.LEADING_LOPNS,// use
                NegotiationStatus.DEFAULT,// negotiationStatus
                1,// negotiationValue (default value)
    ...
    public boolean checkConstraints() {
        try {
            ...
            final int firstBurstLength = getEntry(
                    TextKeyword.FIRST_BURST_LENGTH).getIntegerValue();
            final int maxBurstLength = getEntry(TextKeyword.MAX_BURST_LENGTH)
                    .getIntegerValue();
