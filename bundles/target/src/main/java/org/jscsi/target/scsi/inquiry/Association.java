 ...
 * IDENTIFICATION DESCRIPTORs. It indicates the entity with which the
 * IDENTIFIER field is associated, as described in the following table.
 * 
 * <table border="1">
 *  <tr>
 *   <th>Code</th>
 ...
 *  <tr>
 *   <td>01b</td>
 *   <td>The IDENTIFIER field is associated with the target port that<br>received the request.</td>
 *  <tr>
 *  <tr>
 *   <td>10b</td>
 *   <td>The IDENTIFIER field is associated with the SCSI target device<br>that contains the addressed logical unit.</td>
 *  <tr>
 *  <tr>
 *   <td>11b</td>
 *   <td>Reserved</td>
