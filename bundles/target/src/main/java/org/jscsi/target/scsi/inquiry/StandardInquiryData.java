...
public final class StandardInquiryData implements IResponseData {
    ...
    public void serialize(ByteBuffer byteBuffer, int index) {
         ...
         * 0
         * 
         * A NORMACA (normal auto contingency allegiance) bit set to zero
         * indicates that the device server does not support a NACA bit set to
         * one and does not support the ACA task attribute.
         * 
         * HISUP (bit 4):
         * 
         * 0
         * 
         * A hierarchical support (HISUP) bit set to zero indicates the SCSI
         * target device does not use the hierarchical addressing model to
         ...
         * 0
         * 
         * An SCC Supported bit set to zero indicates that the SCSI target
         * device does not contain an embedded storage array controller
         * component.
         * 
         * ACC (bit 6):
         * 
         * 0
         * 
         * An ACC bit set to zero indicates that no access controls coordinator
         ...
         * 00b
         * 
         * The contents of the target port group support (TPGS) indicate the
         * support for asymmetric logical unit access. The SCSI target device
         * does not support asymmetric logical unit access or supports a form of
         * asymmetric access that is vendor specific. Neither the REPORT TARGET
         * GROUPS nor the SET TARGET GROUPS commands is supported.
         * 
         * 3PC (bit 3):
         * 
         * 0
         * 
         * A Third-Party Copy (3PC) bit set to zero indicates that the SCSI
         * target device does not support third-party copy commands such as the
         ...
         * BQUE (bit 7):
         * 
         * The CMDQUE bit and BQUE bit indicate whether the logical unit
         * supports the full task management model.
         * 
         * 1 (and 0)
         * 
         ...
         * 0
         * 
         * An ENCSERV bit set to zero indicates that the SCSI target device does
         * not contain an embedded enclosure services component.
         * 
         ...
         * 0
         * 
         * A Multi Port (MULTIP) bit set to zero indicates that this is not a
         * multi- port (two or more ports) SCSI target device and therefore does
         * not conform to the SCSI multi-port device requirements found in the
         * applicable standards (e.g., SAM-3, a SCSI transport protocol standard
         * and possibly provisions of a command standard).
         * 
         * MCHNGR (bit 3):
         * 
         * 0
         * 
         * The MCHNGR bit is valid only when the RMB bit is equal to one. A
         * MCHNGR bit set to zero indicates that the SCSI target device does not
         * support commands to control an attached media changer.
         * 
         * (bits 2 and 1 are RESERVED)
         * 
         * ADDR16 (bit 0):
         ...
         * 0
         * 
         * A LINKED bit set to zero indicates the device server does not support
         * linked commands.
         * 
         * CMDQUE (bit 1):
         * 
         ...
         * left-aligned ASCII data identifying the vendor of the product.
         * 
     ...
     * @param string
     *            contains the characters to copy
     * @param position
     *            where the first character of the {@link String} will be put
     * @param fieldLength
