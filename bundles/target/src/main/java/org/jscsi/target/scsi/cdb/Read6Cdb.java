 ...
 * logical block(s) and transfer them to the data-in buffer. Each logical
 * block read includes user data and, if the medium is formatted with
 * protection information enabled, protection information. Each logical
 * block transferred includes user data but does not include protection
 * information.
 * <p>
...
public class Read6Cdb extends ReadCdb {
	...
	protected int deserializeTransferLength(ByteBuffer buffer) {
		 ...
		 * blocks shall be read. Any other value specifies the number of
		 * logical blocks that shall be read.
		 */
