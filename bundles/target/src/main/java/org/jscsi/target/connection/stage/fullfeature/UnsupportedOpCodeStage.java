...
/**
 * Unlike the other subclasses of {@link TargetFullFeatureStage}, this
 * class is not associated with a single {@link ScsiOperationCode}.
 * All SCSI Command PDUs containing a SCSI OpCode not supported by the
 * jSCSI Target (i.e. without a dedicated FullFeatureStage to process
 * them) shall be passed to the {@link #execute(ProtocolDataUnit)}
 * method of this class, which will dispatch a standard SCSI Response
 * PDU stating that the given {@link ScsiOperationCode} is not
