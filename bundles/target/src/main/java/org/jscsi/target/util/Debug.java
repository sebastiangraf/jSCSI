 ...
 * {@link ByteBuffer} objects. The individual values will be
 * printed in hexadecimal format in a tabular arrangement.
...
public class Debug {
	...
	/**
	 * Returns a string containing the buffered values in the defined
	 * format.
