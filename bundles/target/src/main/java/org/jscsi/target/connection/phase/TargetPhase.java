 ...
 * <p>
 * To start a phase, one of the <i>execute</i> methods must be called,
 * which one is sub-class-specific.
...
public abstract class TargetPhase {
	 ...
	 * @throws SettingsException if the target tries to access a parameter
	 * that has not been declared or negotiated and that has no default value
	 */
	public boolean execute(ProtocolDataUnit pdu) throws OperationNotSupportedException,
	IOException, InterruptedException, InternetSCSIException, DigestException,
	SettingsException {
	...
	InternetSCSIException, DigestException, IOException, InterruptedException,
	SettingsException {
		throw new OperationNotSupportedException();
	}
