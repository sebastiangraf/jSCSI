...
/**
 * A class representing the content of LONG LBA MODE PAREMETER
 * LOGICAL BLOCK DESCRIPTOR fields, which are part of
 * {@link ModeParameterList} objects.
 * This long format must be used if the LONG LBA bit is set in
 * the {@link ModeParameterList} objects's header.
