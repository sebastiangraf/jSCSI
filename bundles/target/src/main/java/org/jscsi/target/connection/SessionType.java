...
public enum SessionType {
	...
	/**
	 * The session type as a text parameter negotiation <i>value</i> (as used
	 * in <i>key-value</> pairs).
	 */
	private final String value;
	
	/**
	 * The constructor.
	 * @param value the text parameter negotiation <i>value</i> (as used
	 * in <i>key-value</> pairs) describing this session type.
	 */
	...
	/**
	 * Returns a {@link SessionType} based on the <i>value</i>, which must
	 * be either <code>Discovery</code> or <code>Normal</code>. Otherwise
