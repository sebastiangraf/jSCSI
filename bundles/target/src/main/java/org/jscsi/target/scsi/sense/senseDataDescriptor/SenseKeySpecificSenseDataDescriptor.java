 ...
 * about the exception condition. The format and content of the sense-key specific
 * data depends on the value in the {@link SenseData#senseKey} field.
...
public final class SenseKeySpecificSenseDataDescriptor extends SenseDataDescriptor {
	...
	public SenseKeySpecificSenseDataDescriptor(
		...
		super(SenseDataDescriptorType.SENSE_KEY_SPECIFIC,
				0x06);//additional length
