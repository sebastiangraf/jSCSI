...
public final class Settings {
	...
	/**
	 * The {@link #settingsId} variable allows to compare the age of
	 * different {@link Settings} objects - newer instances have a higher
	 * {@link #settingsId}.
	 * <p>
	 * What it is really used for, however, is for determining if the
	 * buffered {@link Settings} object, which can be accessed via
	 * {@link ConnectionSettingsNegotiator#getSettings()} is up to date
	 ...
	 * @param c {@link ConnectionSettingsBuilderComponent} with the current
	 * connection-specific parameters
	 * @param s {@link SessionSettingsBuilderComponent} with the current
	 ...
	 * @throws SettingsException if the parameter has not been declared or
	 * negotiated and there is no default value
	 */
