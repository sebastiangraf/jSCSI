...
public final class SingleNumericalValue extends NumericalValue {
	 ...
	 * The constructor.
	 * <p>
	 * This method is private to enforce usage of {@link #create(int)},
	 * similar to the way new {@link NumericalValueRange} objects are
	 * created.
	...
	/**
	 * Parses a {@link SingleNumericalValue} from a {@link String}.
	 * The parameter must contain an integer value in decimal, hexadecimal,
	 * or Base64 format. If it does not, <code>null</code> will be returned.
	 ...
	 * required format.
	 * @param value a {@link String} containing (only) an integer encoded
	 * in decimal format 
	...
	private static final int parseHexConstantString(final String value) {
		return Integer.parseInt(
				value.substring(2),//skip "0x" prefix
				16);
	}
