...
/**
 * This Vital Product Data page contains a list of the VPD page codes
 * supported by the logical unit.
 * <p>
 * This class uses the singleton pattern since the list of supported
 * Vital Product Data page requests will never change.
 * @author Andreas Ergenzinger
 */
public final class SupportedVpdPages implements IResponseData {
	
	/**
	 * The total length of all fields that are not part of the
	...
	/*
	 * determine which pages to support
	 * must be in ascending order
	 * see PAGECode.VitalProductDataPageName
	 */
	...
	public void serialize(ByteBuffer byteBuffer, int index) {
		 ...
		 * connected, it also shall use this peripheral qualifier.
		 * This peripheral qualifier does not mean that the peripheral
	...
	/**
	 * Returns <code>true</code> for those and only for those VPD Page
	 * Codes which are supported by the jSCSI Target.
	 * @param vitalProductDataPageName VPD Page Name whose support is
	 * inquired
	 * @return <code>true</code> for those and only for those VPD Page
	 * Codes which are supported by the jSCSI Target
	 */
