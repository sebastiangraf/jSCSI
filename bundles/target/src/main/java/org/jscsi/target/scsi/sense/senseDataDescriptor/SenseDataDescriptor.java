...
public abstract class SenseDataDescriptor implements ISerializable {
	...
	/**
	 * The descriptor type field determines sense data descriptor's (non-abstract)
	 * class.
	 * 
	 ...
	 * @param descriptorType determines the specific type of the sense data
	 * descriptor
	...
	/**
	 * Serializes all fields which are not common to all sense data
	 * descriptors, which means those that are sub-type-specific.
	 * @param byteBuffer where the serialized fields will be stored
	 * @param index the position of the first byte of the sense data
	 * descriptor in the {@link ByteBuffer}
	 */
