...
public final class BooleanEntry extends Entry {
	 ...
	 * @param negotiationValue together with the <i>resultFunction</i> parameter
	 * this value indicates the values supported by the jSCSI Target
	 ...
	 */
	public BooleanEntry(final KeySet keySet,
			final Use use,
	...
	@Override
	public Entry copy() {
		final BooleanEntry e = new BooleanEntry(keySet, use,
				negotiationStatus, negotiationValue, resultFunction,
				(Boolean)value);
