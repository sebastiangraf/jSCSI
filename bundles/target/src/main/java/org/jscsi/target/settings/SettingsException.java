...
/**
 * A new {@link SettingsException} must be thrown every time someone tries
 * to <i>get</i> an undefined parameter from a {@link Settings} object (i.e.
 * an attempt is made to retrieve a parameter that has neither been declared
 * nor negotiated and for which there is no default value).
