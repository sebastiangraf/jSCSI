 ...
 * {@link SessionSettingsNegotiator}. The former one is in charge of all
 * {@link Entry} objects with connection-specific parameters, the latter is in
...
public abstract class SettingsNegotiator {
     ...
     */
    static final Entry getEntry(final String key,
