...
public final class ModeParameterListBuilder {
	...
	/**
	 * The {@link HeaderType} to be used by the
	 * {@link ModeParameterList}.
	 */
	final HeaderType headerType;
	
	/**
	 * Contains all elements to be included in the
	 * list of {@link LogicalBlockDescriptor} objects
	 * of the {@link ModeParameterList}.
	 */
	LogicalBlockDescriptor[] logicalBlockDescriptors;
	
	/**
	 * If the {@link ModeParameterList} uses a
	 * {@link HeaderType#MODE_PARAMETER_HEADER_10} and this
	 * value is <code>true</code>, then all contained MODE
	 * PARAMETER BLOCK DESCRIPTORs will have the LONG LBA
	...
	public void setLogicalBlockDescriptors(
		...
		final ShortLogicalBlockDescriptor[] array =
			new ShortLogicalBlockDescriptor[1];
	...
	boolean checkIntegrity() {
		if (headerType == null)
			return false;
		if (headerType == HeaderType.MODE_PARAMETER_HEADER_6 &&
				longLba)
			return false;
		return true;
	}
