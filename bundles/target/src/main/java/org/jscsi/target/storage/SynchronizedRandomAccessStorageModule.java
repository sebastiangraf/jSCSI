...
public class SynchronizedRandomAccessStorageModule extends
        RandomAccessStorageModule implements IStorageModule {

    protected SynchronizedRandomAccessStorageModule(long sizeInBlocks,
            RandomAccessFile randomAccessFile) throws FileNotFoundException {
