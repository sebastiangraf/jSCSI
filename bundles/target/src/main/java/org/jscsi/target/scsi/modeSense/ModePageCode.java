 ...
 * <p>
 * Instances of this enumeration are used to identify a requested
 * or a returned {@link ModePage}.
...
public enum ModePageCode {
	...
	ENCLOSURE_SERVICES_MANAGEMENT_MODE_PAGE(0x14, 0x00),//do not support, since ENCSERV bit in Inquiry data is 0
	...
	ENCLOSURE_SERVICES_MANAGEMENT_MODE_PAGE_SUBPAGES(0x14, 0xff),//do not support, since ENCSERV bit in Inquiry data is 0
	INFORMATIONAL_EXCEPTIONS_CONTROL_MODE_PAGE_SUBPAGES(0x1c, 0xff),
	LOGICAL_BLOCK_PROVISIONING_MODE_PAGE_SUBPAGES(0x1c, 0xff),
	POWER_CONDITION_MODE_PAGE_SUBPAGES(0x1a, 0xff),
	PROTOCOL_SPECIFIC_LUN_MODE_PAGE_SUBPAGES(0x18, 0xff),
	PROTOCOL_SPECIFIC_PORT_MODE_PAGE_SUBPAGES(0x19, 0xff),
	READ_WRITE_ERROR_RECOVERY_MODE_PAGE_SUBPAGES(0x01, 0xff),
	VERIFY_ERROR_RECOVERY_MODE_PAGE_SUBPAGES(0x07, 0xff),
	XOR_CONTROL_MODE_PAGE_SUBPAGES(0x10, 0xff);
	
	/**
	 * Allows the retrieval of {@link ModePageCode} instances based on
	 * merged PAGE CODE and SUBPAGE CODE field values.
	...
	/**
	 * Merges the the passed PAGE CODE and SUBPAGE CODE field values
	 * to a single value
	 * @param pageCode the value of a PAGE CODE field
	 * @param subpageCode the value of a SUBPAGE CODE field
	 * @return a merged value containing the relevant bits from both
	 * parameters
	 */
