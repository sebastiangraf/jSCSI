...
/**
 * The SELECT REPORT field is a member of the {@link ReportLunsCDB}
 * and specifies the types of logical unit addresses that shall be
 * reported.
 * <p>
...
public enum SelectReport {
	...
	/**
	 * The list shall contain the logical units accessible to the I_T nexus with the
	 * following addressing methods (see SAM):
	 * <ol>
	...
	/**
	 * The list shall contain only well known logical units, if any. If there are no
	 * well known logical units, the LUN LIST LENGTH field shall be zero.
	 */
	...
	/**
	 * Returns the {@link SelectReport} corresponding to the
	 * passed value.
	 * @param value the value of a SELECT REPORT field
	 * @return the {@link SelectReport} corresponding to the
