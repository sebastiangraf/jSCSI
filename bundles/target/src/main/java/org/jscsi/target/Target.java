...
public final class Target {
	...
	/**
	 * The {@link AbstractStorageModule} granting access to the target's
	 * storage medium.
	 */
	 ...
	 * {@link ProtocolDataUnit}s' <code>Target Transfer Tag</code>
	 * field, unless that field is reserved.
	 */
	 ...
	 * <code>Target Transfer Tag</code> field of the next PDU to be sent
	 * by the jSCSI Target.
	...
	/**
	 * Reads target settings from configuration file and stores them in
	 * the {@link #config} object. Returns <code>false</code>
	 * if the operation could not be completed successfully, else it returns
	 * <code>true</code>.
	 * @return <code>true</code> if the target settings were read from
	 * the configuration file, <code>false</code> otherwise.
	...
	private static final void readLog4jConfigurationFile() {
		...
		else //use resources directory (location used during development) 
