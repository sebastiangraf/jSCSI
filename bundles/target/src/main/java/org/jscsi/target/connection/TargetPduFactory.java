 ...
 * <p>
 * The static build methods of this class have a parameter for each
 * field and flag of the respective PDU type, except for <code>StatusSN</code>,
 * <code>ExpCmdSN</code>, and <code>MaxCmdSN</code> fields, which are set during
 * the send process (see {@link TargetSenderWorker#sendOverWire(ProtocolDataUnit)}). 
 */
public class TargetPduFactory {
	...
	public static final ProtocolDataUnit createSCSIResponsePdu (
			...
			final SCSIStatus status,
			final int initiatorTaskTag,
			final int snackTag,
			final int expectedDataSequenceNumber,
			final int bidirectionalReadResidualCount,
	...
	public static final ProtocolDataUnit createNopInPDU(
			final long logicalUnitNumber,
			final int initiatorTaskTag,
			final int targetTransferTag,
			final ByteBuffer dataSegment) {
