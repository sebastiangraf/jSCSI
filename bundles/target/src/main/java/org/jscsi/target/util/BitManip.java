 ...
 * <p>
 * Setting a bit is a little bit more complicated. The byte to be changed
 * must be set to the return value of
...
public final class BitManip {
	...
	/**
	 * Sets a single bit. If the <i>value</i> parameter is <code>true</code>, the
	 * bit will be set to <code>one</code>, and to <code>zero</code> otherwise.
