...
public abstract class SenseKeySpecificData implements ISerializable {
	...
	/**
	 * <code>true</code> if and only if the information fields
	 * of this data object are valid.
	 */
	protected final boolean senseKeySpecificDataValid;
	
	/**
	 * The absctract constructor.
	 * @param senseKeySpecificDataValid <code>true</code> if and only
	 * if the information fields of this data object are valid
	 */
	 ...
	 * @param index the position of the first byte of the sense data
	 * descriptor in the {@link ByteBuffer}
	 */
	...
	/**
	 * Serializes all fields which are not common to all
	 * sense-key-specific data, which means those that are
	 * sub-type-specific.
	 * @param byteBuffer where the serialized fields will be stored
	 * @param index the position of the first byte of the sense data
	 * descriptor in the {@link ByteBuffer}
