 ...
 * <p>
 * The WRITE (6) command requests that the device server transfer the specified
 * logical block(s) from the data-out buffer and write them.
 * <p>
 * Each logical block transferred includes user data but does not include
 * protection information. Each logical block written includes user data and, if
 * the medium is formatted with protection information enabled, protection
 * information.
 * <p>
 * A TRANSFER LENGTH field set to zero specifies that 256 logical blocks shall
 * be written. Any other value specifies the number of logical blocks that shall
 * be written.
 * 
