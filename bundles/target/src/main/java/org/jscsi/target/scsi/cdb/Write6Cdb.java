 ...
 * <p>
 * The WRITE (6) command requests that the device server transfer the
 * specified logical block(s) from the data-out buffer and write them.
 * <p>
 * Each logical block transferred includes user data but does not
 * include protection information. Each logical block written includes
 * user data and, if the medium is formatted with protection information
...
public class Write6Cdb extends WriteCdb {
	...
	protected int deserializeTransferLength(ByteBuffer buffer) {
		 ...
		 * blocks shall be written. Any other value specifies the number of
