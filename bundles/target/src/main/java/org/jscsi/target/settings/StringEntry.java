...
/**
 * This {@link Entry} sub-class is used for managing and negotiation
 * String parameters. The <i>value</i> part of the corresponding
 * <i>key-value</i> pairs can be made up of one or several comma-separated strings.
 * <p>
...
public final class StringEntry extends Entry {
	 ...
	 */
	public StringEntry(final KeySet keySet,
	...
	protected String processNegotiation(Object values) {
		...
		final String[] commonValues =
			TextParameter.intersect(supportedValues, requestedValues);
	...
	@Override
	public Entry copy() {
		final StringEntry e = new StringEntry(keySet, negotiationType,
				use, negotiationStatus, supportedValues,
				(String)value);
