...
public final class StringEntry extends Entry {
    ...
    public StringEntry(final KeySet keySet,
            ...
            final String[] supportedValues, final Object defaultValue) {
    ...
    protected String processNegotiation(Object values) {
        ...
        final String[] commonValues = TextParameter.intersect(supportedValues,
                requestedValues);
    ...
    @Override
    public Entry copy() {
        final StringEntry e = new StringEntry(keySet, negotiationType, use,
                negotiationStatus, supportedValues, (String) value);
