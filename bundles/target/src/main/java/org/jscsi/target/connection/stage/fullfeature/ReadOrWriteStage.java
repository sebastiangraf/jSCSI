...
/**
 * This is an abstract superclass for stages that handle PDUs with
 * command descriptor blocks of the {@link ReadOrWriteCdb} class.
...
public abstract class ReadOrWriteStage extends TargetFullFeatureStage {
	 ...
	 * LENGTH</code> fields in the passed {@link ReadOrWriteCdb} are
	 * acceptable. If illegal values are detected, an instance of
	 * {@link FieldPointerSenseKeySpecificData} describing the problem will
	 * be added to the {@link ReadOrWriteCdb}'s queue- 
