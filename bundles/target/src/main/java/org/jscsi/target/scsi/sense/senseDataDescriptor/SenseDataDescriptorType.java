 ...
 * <p>
 * Vendor specific sense data descriptors types (values 0x80 to 0xff) and
 * respective {@link SenseDataDescriptor}s are not implemented!
 * 
...
public enum SenseDataDescriptorType {
     ...
     * sense-key specific data depends on the value in the
