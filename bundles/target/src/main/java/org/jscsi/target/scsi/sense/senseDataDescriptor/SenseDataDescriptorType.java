...
/**
 * The SenseDataDescriptorType is part of a {@link SenseDataDescriptor} and determines
 * the object's (non-abstract sub)class.
 * <p>
...
public enum SenseDataDescriptorType {
	...
	/**
	 * The information sense data descriptor provides information that is device-type
	 * or command specific and is defined in a command standard.
	 */
	INFORMATION((byte)0x00),
	/**
	 * The command-specific information sense data descriptor provides information that
	 * depends on the command on which the exception condition occurred.
	 */
	COMMAND_SPECIFIC_INFORMATION((byte)0x01),
	/**
	 * The sense key specific sense data descriptor provides additional information about
	 * the exception condition. The format and content of the sense-key specific data
	 * depends on the value in the {@link SenseData#senseKey} field.
	 */
	SENSE_KEY_SPECIFIC((byte)0x02),
	/**
	 * The field replaceable unit sense data descriptor (see table 24) provides information
	 * about a component that has failed.
	 */
