...
class Pattern_Daten
{
	...
	/**
	 * Falls dieses Segment h�ufig angesteuert wird, muss ein Zugriff wenig
	 * z�hlen, dies bewerkstelligt diese Methode.
	 */
	...
	/**
	 * Falls dieses Segment h�ufig angesteuert wird, muss ein Zugriff schneller
 ...
 * ordnet die Sprungweiten den einzelnen S�ulen zu.
 * @author H. Janetzko
 */
class Histogramm_Daten
{
	...
	/**
	 * Hier wird die Sprungweite �bergeben und an die passende S�ule 
	 * weitergegeben.
	...
	/**
	 * Um die Zeiteinheit um eins h�her zu setzen muss jede S�ule auch
	 * wissen, das es jetzt eine Zeiteinheit sp�ter ist, dies wird
	 * hier erledigt.
	 */
	...
	/**
	 * Hier wird allen S�ulen der Wert 0 zugewiesen.
	 */
	public void reset()
	{
		for (int i=0;i<count.length;i++)
...
/**
 * Die Klasse Werte stellt eine einzelne S�ule dar, die sich immer die letzten
 * 5 Werte merkt und anhand eines Zeitz�hlers die �lteren vergisst, wobei
...
class Bin_data
{
	...
	/**
	 * Der Wert zum aktuellen Zeitstempel wird um eins erh�ht; 
	 */
	...
	/**
	 * Der Zeitz�hler wird um eins hochgez�hlt.
	 */
	 ...
	 * viertneuester Wert*0.125 + f�nftneuester Wert*0.0625)
	 */
	...
	/**
	 * Hier wird der Gesamtwert zur�ckgegeben.
