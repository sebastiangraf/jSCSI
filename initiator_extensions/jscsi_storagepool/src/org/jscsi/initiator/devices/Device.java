 ...
 * governing permissions and limitations under the License. $Id: Device.java
...
public interface Device {
  ...
  /**
   * Write data to this device. All bytes from <code>data</code> will be written
   * to blockaddress <code>address</code> on this device.
   * 
   * @param address
